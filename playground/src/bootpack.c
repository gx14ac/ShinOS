...
extern void boxfill_8(unsigned char *vram, int xsize, unsigned char c, int x0, int y0, int x1, int y1);
extern void init_screen(char *vram, int x, int y);
extern void put_font8(char *vram, int xsize, int x, int y, char c, char *font);
extern void putfonts8_asc(char *vram, int xsize, int x, int y, char c, unsigned char *s);
extern void sprintf(char *str, char *fmt, ...);
extern void init_mouse_cursor8(char *mouse, char background_color);
